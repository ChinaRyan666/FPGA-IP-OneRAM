...
HD_PWD='E:/FPGA/z2/ip_1port_ram/prj/ip_1port_ram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_1port_ram.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ip_1port_ram.tcl -notrace
