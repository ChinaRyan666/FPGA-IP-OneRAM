...
HD_PWD='E:/FPGA/z2/ip_1port_ram/prj/ip_1port_ram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_1port_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_1port_ram.tcl
